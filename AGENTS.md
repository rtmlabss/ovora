...
- Workspace ID: `c878d39a-e7c8-4f61-8c2e-568690727a3a`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/c878d39a-e7c8-4f61-8c2e-568690727a3a.
...
2. `npx ngodingpakeai connect --workspace c878d39a-e7c8-4f61-8c2e-568690727a3a --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/c878d39a-e7c8-4f61-8c2e-568690727a3a. Only pass on links the CLI actually printed — never assemble one from an id yourself.
